...
public:
    ...
    Node (
        ...
        , m_config (config)
        , m_node_id (SkywellPublicKey::createFromInteger (m_id))
    ...
    SkywellPublicKey const& node_id () const
    {
        return m_node_id;
    }
...
public:
    ...
    PeerFinderTests () : UnitTest ("PeerFinder", "skywell", runManual)
    {
    }
};
