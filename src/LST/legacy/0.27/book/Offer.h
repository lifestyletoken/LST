...
#ifndef SKYWELL_LEGACY_CORE_OFFER_H_INCLUDED
#define SKYWELL_LEGACY_CORE_OFFER_H_INCLUDED
...
#include <skywell/protocol/STLedgerEntry.h>
#include <skywell/protocol/SField.h>
