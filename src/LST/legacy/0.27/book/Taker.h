...
#ifndef SKYWELL_LEGACY_CORE_TAKER_H_INCLUDED
#define SKYWELL_LEGACY_CORE_TAKER_H_INCLUDED

#include <skywell/legacy/0.27/book/Amounts.h>
#include <skywell/legacy/0.27/book/Quality.h>
#include <skywell/legacy/0.27/book/Offer.h>
