...
Taker::flow (Amounts amount, Offer const& offer, Account const& taker)
{
    ...
    std::uint32_t const taker_charge_rate (skywellTransferRate (view (),
    ...
    std::uint32_t const owner_charge_rate (skywellTransferRate (view (),
...
Taker::cross (Offer const& leg1, Offer const& leg2)
{
    ...
    // us because the output of leg1 and the input leg2 are SWT.
