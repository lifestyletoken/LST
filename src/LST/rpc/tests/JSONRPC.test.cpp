...
#include <skywell/protocol/TxFlags.h>
#include <skywell/rpc/impl/TransactionSign.h>
...
{R"({
    ...
    "tx_json": {
        ...
        "Amount": "1000000000",
        "Destination": "jnUy2SHTjB9DubsPmkJZUXTf5FcNDGjYEA",
...
// Cannot create SWT to SWT paths.
{R"({
    "command": "submit",
    "secret": "masterpassphrase",
    "build_path": 1,
...
// Even though "Amount" may not be SWT for pathfinding, "SendMax" may be SWT.
{R"({
    "command": "submit",
    "secret": "masterpassphrase",
    "build_path": 1,
...
public:
    ...
    {
        SkywellAddress rootSeedMaster
                = SkywellAddress::createSeedGeneric ("masterpassphrase");
        SkywellAddress rootGeneratorMaster
                = SkywellAddress::createGeneratorPublic (rootSeedMaster);
        SkywellAddress rootAddress
                = SkywellAddress::createAccountPublic (rootGeneratorMaster, 0);
...
BEAST_DEFINE_TESTSUITE(JSONRPC,skywell_app,skywell);
