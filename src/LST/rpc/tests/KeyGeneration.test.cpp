...
#include <skywell/rpc/handlers/WalletPropose.h>
#include <skywell/rpc/impl/KeypairForSignature.h>
...
{
    "j4Vtr2rjfmTVZGfSP3gH9hQPMqFPQFin8f",
    common::master_key,
    common::master_seed,
...
{
    "j4qV6xTXejqaZav3MJfSY79ynmc1BSBev1",
    common::master_key,
    common::master_seed,
    common::master_seed_hex,
...
class WalletPropose_test : public skywell::TestSuite
{
public:
...
class KeypairForSignature_test : public skywell::TestSuite
{
public:
    void testEmpty()
    {
...
BEAST_DEFINE_TESTSUITE(WalletPropose,skywell_basics,skywell);
BEAST_DEFINE_TESTSUITE(KeypairForSignature,skywell_basics,skywell);
