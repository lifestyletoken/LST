...
#ifndef SKYWELL_UNITY_HYPERLEVELDB_H_INCLUDED
#define SKYWELL_UNITY_HYPERLEVELDB_H_INCLUDED

#include <beast/Config.h>

#if ! BEAST_WIN32

#define SKYWELL_HYPERLEVELDB_AVAILABLE 1
...
#define SKYWELL_HYPERLEVELDB_AVAILABLE 0
