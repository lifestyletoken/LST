...
#include <skywell/basics/CheckLibraryVersions.h>
#include <skywell/basics/impl/CheckLibraryVersionsImpl.h>
...
BEAST_DEFINE_TESTSUITE(CheckLibraryVersions, skywell_basics, skywell);
