...
#include <skywell/basics/ToString.h>
...
public:
    ...
    void testUnHex ()
    {
        ...
        testUnHexSuccess ("526970706c6544", "SkywellD");
        testUnHexSuccess ("A", "\n");
        testUnHexSuccess ("0A", "\n");
...
BEAST_DEFINE_TESTSUITE(StringUtilities, skywell_basics, skywell);
