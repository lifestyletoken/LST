...
#include <skywell/core/impl/LoadFeeTrackImp.h>
#include <skywell/core/Config.h>
#include <skywell/core/ConfigSections.h>
#include <skywell/basics/TestSuite.h>
...
{
    static boost::format configContentsTemplate (R"skywellConfig(
[server]
port_rpc
port_peer
port_wss_admin
...
# This is primary persistent datastore for skywelld.  This includes transaction
# metadata, account states, and ledger headers.  Helpful information can be
# found here: https://skywell.com/wiki/NodeBackEnd
# delete old ledgers while maintaining at least 2000. Do not require an
# external administrative command to initiate deletion.
[node_db]
type=memory
path=/Users/dummy/skywell/config/db/rocksdb
open_files=2000
filter_bits=12
cache_mb=256
file_size_mb=8
...
[debug_logfile]
/Users/dummy/skywell/config/log/debug.log
...
public:
    void testLegacy ()
    {
        ...
        std::string toLoad(R"skywellConfig(
[server]
port_rpc
port_peer
port_wss_admin
...
BEAST_DEFINE_TESTSUITE (Config, core, skywell);
