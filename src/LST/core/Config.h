...
#include <skywell/basics/BasicConfig.h>
#include <skywell/protocol/SystemParameters.h>
#include <skywell/protocol/SkywellAddress.h>
...
public:
    ...
    */
    ...
    std::uint32_t                      FEE_ACCOUNT_RESERVE;    // Amount of units not allowed to send.
    std::uint32_t                      FEE_OWNER_RESERVE;      // Amount of units not allowed to send per owner entry.
