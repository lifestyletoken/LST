...
#include <skywell/nodestore/impl/codec.h>
...
BEAST_DEFINE_TESTSUITE_MANUAL(import,NodeStore,skywell);
...
BEAST_DEFINE_TESTSUITE_MANUAL(rekey,NodeStore,skywell);
...
BEAST_DEFINE_TESTSUITE_MANUAL(update,NodeStore,skywell);
